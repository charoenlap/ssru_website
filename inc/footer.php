<footer>
	<div class="container">
		<div class="row">
			<div class="col-md-3">
				<h5 class="text-dark font-weight-bold"><?php echo $lan['inform_system']; ?></h5>
			...
			<div class="col-md-3">
				<h5 class="text-dark font-weight-bold"><?php echo $lan['fms_name']; ?></h5>
				<ul class="list-unstyled">
			...
			<div class="col-md-3">
				<h5 class="text-dark font-weight-bold"><?php echo $lan['questionnaire']; ?></h5>
				<ul class="list-unstyled">
					<li><a href="http://poll.ssru.ac.th/login.php" class="text-white"><?php echo $lan['questionnaire_online']; ?> </a></li>
				</ul>
			</div>
			<div class="col-md-3">
				<h5 class="text-dark font-weight-bold"><?php echo $lan['other']; ?></h5>
				<ul class="list-unstyled">
