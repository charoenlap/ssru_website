	...
	<div class="bg-theme">
		<div class="container">
			<div class="col-md-12 text-center">
				<h3 class="text-white mb-0">หลักสูตรที่เปิดสอน</h3>
			</div>
		</div>
	</div>
	<!-- <section class="wow fadeInUp" data-wow-duration="1s">
		<img src="assets/act/images/course1.jpg" alt="" class="w-100">
	</section>
	<section class="wow fadeInUp" data-wow-duration="2s">
		<img src="assets/act/images/course2.jpg" alt="" class="w-100">
	</section> -->
