...
<body>
	...
	<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
		<div class="carousel-inner">
			...
			<div class="carousel-item <?php echo $key==0?'active':''; ?>">
				<a href="">  
					<img class="d-block w-100 fixed-height-banner" src="assets/act/images/ACTlayout.jpg" alt="First slide">
	...
	<section class="position-relative" id="page_course">
		<img src="assets/act/images/ACTlayout2_2.jpg" alt="" class="w-100">
		...
		<div class="btn-overlay">
			<a href="<?php echo route('act/course'); ?>">รายละเอียดเพิ่มเติม</a>
		</div>
	</section>
	<?php 
							...
							<div class="tab-content" id="pills-tabContent">
								...
								<div class="tab-pane fade show <?php echo $key==0?'active':''; ?>" id="pills-home_<?php echo $key; ?>" role="tabpanel" aria-labelledby="pills-home-tab_<?php echo $key; ?>">
									...
									<div class="row pb-3">
										<div class="col-md-12">
											<div class="hover-readmore">
												<img src="<?php echo $mdir.'upload/content/'.$news_content->row[$picture1]; ?>" alt="" class="w-100 hr-images height470">
												<div class="hr-overlay">
													<a href="<?php echo route('act/news-detail','id='.$news_content->row['id']); ?>" class="hr-text" target="_blank"><?php echo $lan['read_more']; ?></a>
													<br>
									...
									<div class="row">
										...
										<div class="col-md-3">
											<div class="hover-readmore">
												<img src="<?php echo $mdir.'upload/content/'.$value[$picture1]; ?>" alt="" class="w-100 hr-images h150">
												<div class="hr-overlay">
									...
									<div class="row">
										...
										<?php foreach ($news_temp as $key => $value) { ?>
											<div class="col-md-12 py-2">
												<div class="hover-readmore">
													<img src="<?php echo $mdir.'upload/content/'.$value[$picture1]; ?>" alt="" class="w-100 hr-images h180">
													<div class="hr-overlay">
								...
								<div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
									<div class="row">
										...
										foreach ($news_popular->rows as $key => $value) {
											...
											<div class="col-md-12 py-2">
												<div class="hover-readmore">
													<img src="<?php echo $mdir.'upload/content/'.$news_data[$picture1]; ?>" alt="" class="w-100 hr-images h180">
													<div class="hr-overlay">
														<a href="<?php echo route('act/news-detail','id='.$news_data['id']); ?>" class="hr-text" target="_blank">Read More</a>
														<br>
	...
	<?php 
	if (!empty($home_cat[3]['id'])) {
		$vdo = $obj_db->cat('ref_id = '.$home_cat[3]['id'].$hide_del_lan_order)->row;
		 ?>
